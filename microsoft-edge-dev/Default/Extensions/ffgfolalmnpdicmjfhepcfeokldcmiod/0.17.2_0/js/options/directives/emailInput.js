(function() {
    var libs, emailInputDirective;
    libs = ["angular", "angular_translate", "options/module", "services/validate", "services/invitationManager", "services/userManager"], 
    emailInputDirective = function(angular) {
        var emailInput;
        return emailInput = function($rootScope, $http, $timeout, $tooltip, $translate, $alert, invitationManager, userManager, validate, SERVER) {
			return {
				restrict: 'E',
				scope: {
				...
				templateUrl: 'partials/options/email_input.html',
...
*/
        ...
        angular.module("options").directive("emailInput", emailInput)
    }, 
    define(libs, emailInputDirective)
}).call(this);