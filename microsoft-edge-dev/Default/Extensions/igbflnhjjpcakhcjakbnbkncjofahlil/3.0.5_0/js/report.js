/* eslint-disable */
(function($) {
  var CFG, exports, _fn, REPORT_TYPE, requestDataArr, defaultData, VIEW_STRATEGY, SERVER_URL, utmData, VERSION, UserInfo, CUSTOM_HREF, CUSTOM_HOST, EXTENSION_ID, pluginSource, CHANNEL_ID, CID;
  requestDataArr = [];
  CFG = {
    DELAY: 500,
    API_VERSION: '0.6.0',
    ...
    getUserInfo: function() {
      return new Promise(resolve => {
        ...
        chrome.cookies.getAll({ url: 'https://csdn.net' }, function(res) {
          const userInfo = res
            .filter(v => ['AU', 'UserNick', 'UserName', 'uuid_tt_dd', '_javaeye_cookie_id_'].indexOf(v.name) > -1)
            .reduce((pre, cur) => {
